...
plt.subplot(2,2,1)
plt.title('1975')
plot_subplots_histogram(df[(df['year'] == 1975) & (df['rh'] <= 0.47)][plotvariable],colour='blue',year='1975')
plt.subplot(2,2,2)
plt.title('1981')
plot_subplots_histogram(df[(df['year'] == 1981) & (df['rh'] <= 0.47)][plotvariable],colour='blue',year='1981')
plt.subplot(2,2,3)
